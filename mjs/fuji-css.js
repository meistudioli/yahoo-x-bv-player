...
:host {
  ...
  --shadow-elevations-2: 0 0 1px rgba(var(--black) / 0.1), 0 2px 4px rgba(var(--black) / 0.08);
  --shadow-elevations-3: 0 0 1px rgba(var(--black) / 0.08), 0 4px 8px rgba(var(--black) / 0.1);
  --shadow-elevations-4: 0 0 2px rgba(var(--black) / 0.05), 0 4px 16px rgba(var(--black) / 0.2);
  --shadow-elevations-5: 0 0 16px rgba(var(--black) / 0.05),
    0 32px 32px 20px rgba(var(--black) / 0.4);
